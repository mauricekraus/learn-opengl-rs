...
pub fn main_2_4_1() {
    ...
    let (shader_cube, shader_light, vao_cube, vao_light, texture) = unsafe {
        // Id generation
        ...
        let shader_cube = Shader::new(
            "src/_2_lighting/shaders/4.1.lighting_maps_diffuse.vert",
            "src/_2_lighting/shaders/4.1.lighting_maps_diffuse.frag",
        );
        ...
        // texture coords
        gl::EnableVertexArrayAttrib(vao_cube, 2);
        gl::VertexArrayAttribBinding(vao_cube, 2, 0);
        gl::VertexArrayAttribFormat(
            vao_cube,
            2,
            2,
        ...
        let img = image::open(&Path::new("resources/textures/container2.png"))
        ...
        gl::TextureParameteri(tex, gl::TEXTURE_MAG_FILTER, gl::LINEAR as i32);
        gl::TextureParameteri(tex, gl::TEXTURE_WRAP_S, gl::REPEAT as i32);
        gl::TextureParameteri(tex, gl::TEXTURE_WRAP_T, gl::REPEAT as i32);
        gl::TextureStorage2D(tex, 1, gl::RGB8, img.width() as i32, img.height() as i32);
        gl::TextureSubImage2D(
            ...
            gl::RGBA,
            gl::UNSIGNED_BYTE,
            data.as_ptr() as *const c_void, // &data[0] as *const u8 as *const c_void,
        );
        gl::GenerateTextureMipmap(tex);

        (shader_cube, shader_light, vao_cube, vao_light, tex)
    };
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            shader_cube.set_int(c_str!("tex"), 0);
