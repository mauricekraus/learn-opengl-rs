...
pub fn main_1_3_1() {
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            let time_value = glfw_instance.get_time() as f32;
            let green_value = time_value.sin() / 2.0 + 0.5;
            let c_uniform = CString::new("ourColor").unwrap();
            let vertex_color_location = gl::GetUniformLocation(shader_prog, c_uniform.as_ptr());
